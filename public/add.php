...
if (isset($_POST['add_produk'])) {
    ...
    if ($fileError === 0) {
        try {
            $perintah_insert = "INSERT INTO produk (kategori,nama_produk, isi_produk, harga_produk, foto_produk)
                                    VALUES ('$kategori','$nama_produk','$teks_baru','$harga_produk','$file_foto') ";
