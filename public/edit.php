...
<body>
  ...
  try {
    ...
    // $result = mysqli_query($connection, $sql_kategori);
        ...
        <form class="px-8 pt-6 pb-8 mb-4" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            ...
            <select name="kategori" id="kategori" class="cursor-pointer px-3 py-2 text-sm font-semibold text-ketiga border ml-4 border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-biru focus:border-biru">
              <option <?php if ($row['kategori'] == "1001") {
                        echo "selected";
                      } ?> value="1001">Tenda</option>

              <option <?php if ($row['kategori'] == "1002") {
                        echo "selected";
                      } ?> value="1002">Gedung</option>

              <option <?php if ($row['kategori'] == "1003") {
                        echo "selected";
                      } ?> value="1003">Panggung</option>

              <option <?php if ($row['kategori'] == "1004") {
                        echo "selected";
                      } ?> value="1004">Alat-alat</option>
            </select>
          </div>
          <div class="mb-4">
          ...
          <div class="mb-6">
            ...
            <div class="flex justify-between">
              <input id="foto_produk" name="foto_produk" type="file" accept=".jpg, .jpeg, .png" class="px-3 py-2 border shadow-md rounded-md w-[40%] h-14 cursor-pointer">
  ...
  if (isset($_POST['update_produk'])) {
    ...
    try {
      ...
      $perintah_update = "UPDATE produk 
              ...
              foto_produk='$file_foto',
              kategori='$kategori' 
              WHERE id_produk='$id_produk' ";

      $perintah_update2 = "UPDATE produk 
              SET nama_produk='$nama_produk', isi_produk='$isi_produk', harga_produk='$harga_produk',kategori='$kategori' 
              WHERE id_produk='$id_produk' ";
